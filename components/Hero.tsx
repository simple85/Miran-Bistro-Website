...
const FLOATERS = [
  { art: "pizza", className: "left-3 top-[58%] w-20 lg:left-[4%] lg:top-[20%] lg:w-44", depth: 60 },
  { art: "burger", className: "right-3 top-[58%] w-20 lg:right-[5%] lg:top-[16%] lg:w-48", depth: 90 },
