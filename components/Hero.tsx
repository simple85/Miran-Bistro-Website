...
const FLOATERS = [
  { art: "pizza", className: "left-[4%] top-[20%] hidden w-28 sm:block sm:w-36 lg:w-44", depth: 60 },
  { art: "burger", className: "right-[5%] top-[16%] hidden w-28 sm:block sm:w-36 lg:w-48", depth: 90 },
